...
import activity.login.loginactivityusinghttpurlconnectio.LoginActivity.LoginRequest;
public class SessionMangement {
    ...
    private static final String PREF_userid = "AndroidHivePref";
    ...
    public SessionMangement(Context context){
        ...
        pref = _context.getSharedPreferences(PREF_userid, PRIVATE_MODE);
        editor = pref.edit();
    }
